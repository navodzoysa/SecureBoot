...
export default function Firmware() {
	...
	const [firmwareDetails, setFirmwareDetails] = useState<any>();
	...
	useEffect(() => {
		if (isAuthenticated) {
			getFirmwareDetailsById();
		}
	}, [isAuthenticated, getFirmwareDetailsById])
	...
	return (
		<Container size='xl'>
			...
			<Card shadow="sm" padding="lg" radius="md" withBorder>
				...
				<div>{firmwareDetails ? firmwareDetails.firmwareName : ''}</div>
			</Flex>
		</Container>
	);
}